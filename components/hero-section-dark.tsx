...
const HeroSection = React.forwardRef<HTMLDivElement, HeroSectionProps>(
  (
    {
      className,
      title = "Our project the video call and chat",
      subtitle = {
        regular: "welcom to our project video call ",
        gradient: "and chat building in Nextjs .",
      },
      description = "if you need to organise your conference and chat with your members you're in a good place.",
